<template>
  <q-page class="q-pa-lg">
        ...
        <q-card-section class="q-pa-lg">
          <div class="text-center">
            ...
            <div class="text-grey-7 text-subtitle2">
              Lengkapi formulir berikut untuk menambahkan acara baru
            </div>
          </div>
    ...
    <ConfirmDialog
      v-model="showConfirm"
      type="warning"
      :title="submitStatus === 'draft' ? 'Simpan Draft' : 'Publish Acara'"
      :message="
        submitStatus === 'draft'
          ? 'Simpan acara sebagai draft?'
          : 'Acara akan langsung tampil ke pengguna. Lanjutkan publish?'
      "
