    ...
    <div v-else-if="meeting.id">
      ...
      <div class="row items-center justify-between q-mb-lg">
        ...
        <div class="q-gutter-sm">
          ...
          <q-btn
            v-if="['Akan Datang', 'Berlangsung'].includes(meeting.status) && isCoordinator && meeting.meeting_type === 2"
            outline
            color="indigo-9"
            icon="checklist"
          ...
          <q-btn
            v-if="meeting.status === 'Akan Datang' && isCoordinator && meeting.meeting_type === 2"
            color="indigo-9"
            icon="play_arrow"
            label="Mulai Rapat"
            rounded
          ...
          <q-btn
            v-if="meeting.status === 'Berlangsung' && isCoordinator && meeting.meeting_type === 2"
            color="negative"
            icon="stop_circle"
        ...
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="minutes">
            ...
            <div v-else-if="!meetingNote" class="text-grey-6">
              ...
              <q-btn
                v-if="isCoordinator && meeting.meeting_type === 2"
                color="indigo-9"
                icon="add"
                label="Buat Notulen"
                no-caps
...
const fetchMeetingDetail = async () => {
  try {
    ...
    console.error(error)
    const errorMsg = error.response?.data?.message || 'Anda tidak memiliki akses ke detail rapat ini.'
    hasError.value = true
